    ...
    async function loadSiteContent() {
      ...
      if (!cancelled && !error && data?.value) {
        ...
        setSiteContent({
          ...initialSiteContent,
          ...value,
          hero: { ...initialSiteContent.hero, ...(value.hero || {}) },
          portfolio: { ...initialSiteContent.portfolio, ...(value.portfolio || {}) },
          profile: { ...initialSiteContent.profile, ...(value.profile || {}) },
          contact: { ...initialSiteContent.contact, ...(value.contact || {}) },
          tools: value.tools || initialSiteContent.tools,
          coreSkills: value.coreSkills || initialSiteContent.coreSkills,
          aiSkills: value.aiSkills || initialSiteContent.aiSkills,
          experience: value.experience || initialSiteContent.experience,
          education: value.education || initialSiteContent.education,
        });
      }
    }
